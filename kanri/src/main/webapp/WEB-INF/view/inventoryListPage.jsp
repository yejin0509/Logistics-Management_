...
<body>
	...
	<main class="container my-4">
		<div
			style="display: flex; align-items: center; gap: 15px; flex-wrap: wrap; margin-bottom: 20px;">

			<!-- 상품 ID 검색 -->
			<form action="/kanri/searchById.do" method="post"
				style="display: flex; align-items: center; gap: 5px;">
				<label for="product_Id">ID:</label> <input type="text"
					id="product_Id" name="product_Id" placeholder="製品ID" /> <input
			...
			<form action="/kanri/searchByName.do" method="post"
				style="display: flex; align-items: center; gap: 5px;">
				<label for="product_Name">製品名前:</label> <input type="text"
					id="product_Name" name="product_Name" placeholder="製品名前" /> <input
					type="submit" value="検索" />
			</form>
			...
			<form action="/kanri/searchByElse.do" method="post"
				style="display: flex; align-items: center; gap: 5px;">
				<label for="location">位置:</label> <select id="location"
					name="location" class="form-select select-no-border">
			...
			<form action="/kanri/nothingInclude.do" method="post"
				style="display: flex; align-items: center; margin-left: auto; margin-right: 3%;">
				<input type="submit" class="btn"
					style="background-color: black; color: white;" value="検索のリセット" />
			</form>
