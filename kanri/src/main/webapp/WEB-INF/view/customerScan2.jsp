    ...
    <main class="container my-4">
        ...
        <div class="mb-4">
            <form action="/kanri/date-filter2.do" method="get" class="d-flex align-items-center gap-2">
                ...
                <input type="date" id="out_Date" name="out_Date" value="${param.out_Date}" class="form-control" style="max-width: 200px;"> <!-- 날짜 입력 필드 -->
            ...
            <tbody>
                ...
                <c:forEach var="OutBound" items="${OutBoundPage.content}" varStatus="status">
                    <tr>
                        ...
                        <td>${OutBound.out_Count}</td> <!-- 출고 수량 -->
                    </tr>
                </c:forEach>
            </tbody>
        </table>
