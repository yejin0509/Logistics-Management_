...
.box1 {
    ...
    display: block;
    width: 55%; /* 100%로 설정하여 부모 요소의 크기에 맞게 */
    height: auto; /* 부모 요소의 높이에 맞게 */
    padding-top: 56.25%; /* 여전히 16:9 비율 유지 */
...
/* 마우스를 올리면 이미지 변경 */
.box1:hover {
    background-image: url('./images/inventory_list_box_open.png');
}
...
/* 마우스를 올리면 이미지 변경 */
.box4:hover {
    background-image: url('./images/outbound_history_box_open.png');
}
    ...
    <div class="body">
        <div class="container1" >
            ...
            <a href="nothingInclude.do">
                <div class="box1"></div> <!-- img에서 div로 변경 -->
            </a>
